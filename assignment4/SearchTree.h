...
private:
	...
	void inOrderTraversal(ostream& out, Node* node) const;
	...
	//----------------------------- compareTrees --------------------------------
	//Determines if trees are exactly the same, node for node.
	//Preconditions: Nodes from each tree are passed in.
	//Postconditions: Trees are determined to be equal or unequal for operator
	// functions.
